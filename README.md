A "Light Calculator" that counts the number of times a PB is pressed. The amount is then divided by a pre-set number "5". The result is displayed by a LED blinking pattern that follows a pattern.
